...
#ggplot2, by Hadley Wickham, is an excellent and 
#flexible package for elegant data visualization 
#in R. However the default generated plots requires 
#some formatting before we can send them for publication. 
#Furthermore, to customize a ggplot, the syntax is 
#opaque and this raises the level of difficulty for 
#researchers with no advanced R programming skills.
...
#Ordered bar plots
#Change the fill color by the grouping variable “cyl”. 
...
#Deviation graphs
#The deviation graph shows the deviation of quantitatives 
#values to a reference value. In the R code below, we’ll 
#plot the mpg z-score from the mtcars dataset.
